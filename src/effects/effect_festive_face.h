...
class EffectFestiveFace : public FixedEffect {
public:
  EffectFestiveFace(const char* name) : FixedEffect(name) {
  }
  ...
  virtual void process(Display& display) {
    ...
    // display.undraw_png(_eyes[_eye_frame], DRAW_MIRROR, 0, 0);
    // display.undraw_png(_nose, DRAW_MIRROR, 48, 0);
    // display.undraw_png(_mouth, DRAW_MIRROR, 0, 16);
